...
import '../../../common/widgets/buttons/favorite_btn.dart';
import '../../../core/configs/contants/conts.dart';
import '../../../core/configs/theme/app_colors.dart';
import '../../../domain/entities/song/song.dart';
import '../bloc/song_player_cubit.dart';
import '../bloc/song_player_states.dart';
    ...
    return  Scaffold(
      ...
      body: BlocProvider(
        create: (_) => SongPlayerCubit()..loadSong(
            '${AppURLs.songFirestorage}${songEntity.artist} - ${songEntity.title}.mp3?${AppURLs.mediaAlt}'.replaceAll(" ", '%20')
        ),
